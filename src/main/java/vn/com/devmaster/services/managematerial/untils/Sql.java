...
public class Sql {
    ...
    public static final String UPDATE_PAYMENT = "update payment_method\n" +
            ...
            "where ID = :idPayment";
    public static final String TOTAL_REVENUE = "select (sum(TOTAL_MONEY) - sum(ot.TOTAL)) as sum\n" +
            "from orders\n" +
            "         inner join orders_transport ot on orders.ID = ot.IDORD\n" +
            "where STATUS = 4";
    public static final String GET_BLOG = "select*from blog where ISACTIVE=1";
